	...
	<div id="info">
		<div class="panel-body">
			<!-- <form action="" method="POST"> -->
				<?php echo form_open('UserData/save',array('id'=>'form-user')); ?>
				<div class="form-horizontal">
					<div class="box-body">
						<div class="form-group">
							<label class="col-sm-2 control-label" for="id">ID</label>
							<div class="col-sm-10">
								<input class="form-control" name="id" id="id" type="text" placeholder="ID" />
				...
				<div class="form-horizontal">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select class="form-control select2" multiple="multiple" name="role" id="role">
